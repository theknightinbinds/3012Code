...
/// <summary>
/// Console.
/// Scripted by Joseph McCallum-Nattrass
...
public class Console : MonoBehaviour
{
	...
	void OnGUI ()
	{
		...
		windowRect = GUILayout.Window(123456, windowRect, ConsoleWindow, "Country Log");
	}
	...
	void ConsoleWindow (int windowID)
	{
		...
		GUILayout.BeginHorizontal();
			...
			if (GUILayout.Button(clearLabel)) {
				entries.Clear();
			Debug.Log("Your performancce depends on your country! V scrolls down through the countries, B scrolls up and R selects one at random.");
			}
